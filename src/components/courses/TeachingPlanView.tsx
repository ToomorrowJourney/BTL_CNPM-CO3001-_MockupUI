 ...
 */
const TeachingPlanLoadingSkeleton: React.FC = () => (
 ...
 */
const EmptyTeachingPlan: React.FC = () => (
...
/**
 * TeachingPlanView Component
 * Displays teaching plan with sessions schedule and documents
 */
const TeachingPlanView: React.FC<TeachingPlanViewProps> = ({
	teachingPlan,
	isLoading,
}) => {
	if (isLoading) {
